        ...
        config = mkIf cfg.enable {
          ...
          systemd.services.meshview-db = {
            ...
            serviceConfig = {
              ...
              ExecStart = "${pkgs.meshview.venv}/bin/python ${pkgs.meshview.src}/startdb.py --config ${configFile}";  #/path/to/meshview/env/bin/python /path/to/meshview/startdb.py --config /path/to/meshview/config.ini
              Restart = "always";
              RestartSec = 5;
            };
          ...
          systemd.services.meshview-web = {
            ...
            serviceConfig = {
              ...
              Group = "meshview";
              WorkingDirectory = cfg.dataDir;
              ExecStart = "${pkgs.meshview.venv}/bin/python ${pkgs.meshview.src}/startdb.py --config ${configFile}";  #/path/to/meshview/env/bin/python /path/to/meshview/main.py --config /path/to/meshview/config.ini
              Restart = "always";
              RestartSec = 5;
            };
          };
